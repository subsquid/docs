...
The [Typegen automated tool](../typegen.md), takes care of generating TypeScript class wrappers for abstract types. Unfortunately, there is no equivalent to this for the EVM Events and Topics, so this has to be done manually. Let's look at an example:
