...
:::info
Note that normally one can use human-readable topic definitions generated by [evm-typegen](/evm-indexing/squid-evm-typegen) from the contract ABI. So in practice, the above snippet would rather look like 
```ts
 //...
 .addLog('0x2E645469f354BB4F5c8a05B3b30A929361cf77eC', {
    filter: [[
