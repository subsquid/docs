...
Take a look at the [Soldexer project](https://soldexer.dev) for a peek at the new client architecture and the most detailed and up-to-date documentation on the updated Portal API.
