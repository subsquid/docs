...
In the [squid-frontier-evm-template](https://github.com/subsquid/squid-frontier-evm-template) repository you'll find a JSON file containing [the ERC721 ABI](https://github.com/subsquid/squid-frontier-evm-template/blob/master/src/abi/ERC721.json) and right next to it, the TypeScript file generated by such tool. Let's dissect and explain what it contains:
