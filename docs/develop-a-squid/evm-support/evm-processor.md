...
To know exactly what this means, please check the related section in the [Archive guide](/archives/how-to-launch-a-squid-archive#launch-archives-for-evm-compatible-blockchain).
