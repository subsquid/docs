...
Some examples of how to use this command can be seen in the [Tutorial to create a simple Squid](/tutorials/create-a-simple-squid#apply-changes-to-the-database).
