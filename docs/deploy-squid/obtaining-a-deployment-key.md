...
To find out other important CLI commands for interacting with our SaaS solution are listed under the [dedicated subsection of complete CLI Reference](/deploy-squid/squid-cli#subcommands-for-squid-command).
