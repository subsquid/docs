...
Further, at each step we will [process the data for the whole batch](/sdk/resources/integration/batch-processing/) instead of handling the items individually. This is crucial for achieving a good syncing performance.
