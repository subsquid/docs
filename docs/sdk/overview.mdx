...
* [`@subsquid/archive-registry`](https://www.npmjs.com/package/@subsquid/archive-registry) simplifies keeping track of available [Subsquid Network](/subsquid-network/overview) datasets.
