...
<details><summary>Templates for the Google BigQuery data destination</summary>
```
...
Use the `.decode` methods from the [contract ABI utilities](#typegen) to decode events and transactions, e.g. like this
