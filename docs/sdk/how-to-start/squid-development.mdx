...
1. Use a data source appropriate for your chain and task.
   - It is possible to [use RPC](/sdk/reference/processors/evm-batch/general/#set-rpc-endpoint) as the only data source, but [adding](/sdk/reference/processors/evm-batch/general/#set-gateway) a [SQD Network](/subsquid-network/reference/evm-networks) data source will make your squid sync much faster.
...
1. Use a data source appropriate for your chain and task
   - [Use](/sdk/reference/processors/substrate-batch/general/#set-gateway) a [SQD Network gateway](/subsquid-network/reference/substrate-networks) whenever it is available. [RPC](/sdk/reference/processors/evm-batch/general/#set-rpc-endpoint) is still required in this case.
