...
```
or, using a [newer](/sdk/resources/basics/serving-graphql/#supported-queries) and [more advanced](/sdk/reference/graphql-server/openreader/paginate-query-results) `{entityName}sConnection` query
