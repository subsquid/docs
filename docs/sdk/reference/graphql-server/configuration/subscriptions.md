...
Note that despite being [deprecated](/sdk/resources/basics/serving-graphql/#supported-queries) from the regular query set, `${EntityName}s` queries will continue to be available for subscriptions going forward.
