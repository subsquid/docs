...
User-facing [API](/subquid-network/reference) between these two is identical. Use it directly whenever you need historical blockchain data older than about 6-24 hours in either **(1)** high volume or **(2)** filtered form.
...
[//]: # (!!!! -  local data extraction of decoded data - meaning?)
