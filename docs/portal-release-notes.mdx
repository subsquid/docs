...
After five months of rigorous load testing and countless iterations, we’re excited to announce the launch of **Portal**, our decentralized, streaming-based data retrieval solution.
...
- **Faster than ever**: The query engine, previously written in Python, has been fully rewritten in Rust. It now leverages parallelized queries, achieving ingestion rates **10-50x faster**.
...
- **Unrivaled performance**: Handle even the heaviest workloads with lightning-fast ingestion rates.
...
- **Simplicity**: Easy for newcomers, powerful for experts.
