...
- Present the target data with a rich API served by a built-in [GraphQL Server](/graphql-server). A full API reference is covered in the [Query a Squid](/query-a-squid) section.
