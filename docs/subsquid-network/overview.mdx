...
The gateway of this private network is public and free to query. URLs for datasets of supported networks are available via [`sqd gateways ls`](/squid-cli/gateways) and on the [Subsquid Network reference pages](/subsquid-network/reference).
...
See the [EVM datasets](/subsquid-network/reference/evm-networks/) page for dataset URLs for all supported networks.
...
See the [Substrate datasets](/subsquid-network/reference/substrate-networks/) page for dataset URLs for all supported networks.
