...
2. An open private network ran by Subsquid **(production-ready)**
   * [Supported EVM networks](/subsquid-network/private/evm-networks)
   * [Supported Substrate networks](/subsquid-network/private/substrate-networks)
...
See the [EVM datasets](/subsquid-network/private/evm-networks/) page for exact lookup calls for all supported networks.
...
See the [Substrate datasets](/subsquid-network/private/substrate-networks/) page for exact lookup calls for all supported networks.
