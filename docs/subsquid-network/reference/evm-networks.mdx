...
(*) Only for EVM data. For Substrate/ink! data use the corresponding [Substrate archive](/subsquid-network/reference/substrate-networks).
...
Here are the raw dataset URLs (retrieved 2024-02-15):
