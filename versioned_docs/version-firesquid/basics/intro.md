...
- Present the target data with a rich API served by a built-in [GraphQL Server](/firesquid/graphql-api). A full API reference is covered in the [Query a Squid](/query-squid) section.
