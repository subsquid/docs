...
```
or, using a [newer](/firesquid/graphql-api/overview/#supported-queries) and [more advanced](/firesquid/query-squid/paginate-query-results) `{entityName}sConnection` query
