...
Our GraphQL implementation offers a vast selection of tools to filter and section results. One of these is the `where` clause, very common in most database query languages and [explained here](/arrowsquid-docs-v0/query-squid/queries/#filter-query-results--search-queries) in detail.
