...
[Generate an ink! indexing squid automatically](/arrowsquid-docs-v0/basics/squid-gen), follow the [WASM squid tutorial](/arrowsquid-docs-v0/tutorials/create-a-wasm-processing-squid) for a step-by-step instruction or check out the [squid-wasm-template](https://github.com/subsquid-labs/squid-wasm-template) reference project.
