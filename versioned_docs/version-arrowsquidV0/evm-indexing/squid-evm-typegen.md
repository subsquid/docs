...
:::info
Please check if your contract is a proxy when using this method. If it is, consult [this page](/arrowsquid-docs-v0/evm-indexing/proxy-contracts) for guidance.
:::
...
See [Batch state queries](/arrowsquid-docs-v0/evm-indexing/query-state/#batch-state-queries) for more context.
