...
Follow [these instructions](/arrowsquid-docs-v0/squid-cli/installation).
...
Most squids [use a database](/arrowsquid-docs-v0/store/postgres) to store the processed data. Install Docker to manage local squid databases with convenience.
