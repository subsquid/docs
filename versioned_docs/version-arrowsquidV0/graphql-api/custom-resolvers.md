...
1. grab a test squid as described [here](/arrowsquid-docs-v0/quickstart/quickstart-ethereum/);
...
`LOG` here is a [logger object](/arrowsquid-docs-v0/basics/logging) identical to `ctx.log` interface-wise.
