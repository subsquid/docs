...
Authentication data such as user name can be passed from `requestCheck()` to a [custom resolver](/arrowsquid-docs-v0/graphql-api/custom-resolvers/) through Openreader context:
```typescript
...
This approach does not work with [subscriptions](/arrowsquid-docs-v0/graphql-api/subscriptions/).
