...
export default function Acala_Status({children, color}) {
    const chain_url    = 'wss://acala-rpc.dwellir.com';
    const gs_chain_url = 'https://squid.subsquid.io/gs-explorer-acala/graphql';
