...
export default function GMordie_Status({children, color}) {
    const chain_url    = 'wss://leemo.gmordie.com';
    const gs_chain_url = 'https://squid.subsquid.io/gs-explorer-gmordie/graphql';
