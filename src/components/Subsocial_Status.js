...
export default function Subsocial_Status({children, color}) {
    const chain_url    = 'wss://para.subsocial.network';
    const gs_chain_url = 'https://squid.subsquid.io/gs-explorer-subsocial/graphql';
