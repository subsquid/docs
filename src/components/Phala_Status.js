...
export default function Phala_Status({children, color}) {
    const chain_url    = 'wss://api.phala.network/ws';
    const gs_chain_url = 'https://squid.subsquid.io/gs-explorer-phala/graphql';
