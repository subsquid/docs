...
export default function Astar_Status({children, color}) {
    const chain_url    = 'wss://astar-rpc.dwellir.com';
    const gs_chain_url = 'https://squid.subsquid.io/gs-explorer-astar/graphql';
