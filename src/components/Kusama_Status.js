...
export default function Kusama_Status({children, color}) {
    const chain_url    = 'wss://kusama-rpc.dwellir.com';
    const gs_chain_url = 'https://squid.subsquid.io/gs-explorer-kusama/graphql';
