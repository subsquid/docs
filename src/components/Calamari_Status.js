...
export default function Calamari_Status({children, color}) {
    const chain_url    = 'wss://calamari.systems';
    const gs_chain_url = 'https://squid.subsquid.io/gs-explorer-calamari/graphql';
