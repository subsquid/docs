...
export default function Bifrost_Status({children, color}) {
    const chain_url    = 'wss://bifrost-rpc.dwellir.com';
    const gs_chain_url = 'https://squid.subsquid.io/gs-explorer-bifrost/graphql';
