...
export default function Interlay_Status({children, color}) {
    const chain_url    = 'wss://api.interlay.io/parachain';
    const gs_chain_url = 'https://squid.subsquid.io/gs-explorer-interlay/graphql';
