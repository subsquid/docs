...
export default function Moonriver_Status({children, color}) {
    const chain_url    = 'wss://moonriver.public.blastapi.io';
    const gs_chain_url = 'https://squid.subsquid.io/gs-explorer-moonriver/graphql';
