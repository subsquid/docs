...
export default function Moonbeam_Status({children, color}) {
    const chain_url    = 'wss://moonbeam.public.blastapi.io';
    const gs_chain_url = 'https://squid.subsquid.io/gs-explorer-moonbeam/graphql';
