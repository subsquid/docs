...
export default function Rococo_Status({children, color}) {
    const chain_url    = 'wss://rococo-rpc.polkadot.io';
    const gs_chain_url = 'https://squid.subsquid.io/gs-explorer-rococo/graphql';
