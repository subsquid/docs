...
export default function Khala_Status({children, color}) {
    const chain_url    = 'wss://khala-rpc.dwellir.com';
    const gs_chain_url = 'https://squid.subsquid.io/gs-explorer-khala/graphql';
