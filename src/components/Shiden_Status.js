...
export default function Shiden_Status({children, color}) {
    const chain_url    = 'wss://shiden-rpc.dwellir.com';
    const gs_chain_url = 'https://squid.subsquid.io/gs-explorer-shiden/graphql';
