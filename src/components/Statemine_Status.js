...
export default function Statemine_Status({children, color}) {
    const chain_url    = 'wss://statemine-rpc.dwellir.com';
    const gs_chain_url = 'https://squid.subsquid.io/gs-explorer-statemine/graphql';
