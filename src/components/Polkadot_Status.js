...
export default function Polkadot_Status({children, color}) {
    const chain_url    = 'wss://polkadot-rpc.dwellir.com';
    const gs_chain_url = 'https://squid.subsquid.io/gs-explorer-polkadot/graphql';
