...
export default function HydraDX_Status({children, color}) {
    const chain_url    = 'wss://hydradx-rpc.dwellir.com';
    const gs_chain_url = 'https://squid.subsquid.io/gs-explorer-hydradx/graphql';
