...
export default function Karura_Status({children, color}) {
    const chain_url    = 'wss://karura-rpc.dwellir.com';
    const gs_chain_url = 'https://squid.subsquid.io/gs-explorer-karura/graphql';
