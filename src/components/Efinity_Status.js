...
export default function Efinity_Status({children, color}) {
    const chain_url    = 'wss://efinity-rpc.dwellir.com';
    const gs_chain_url = 'https://squid.subsquid.io/gs-explorer-efinity/graphql';
