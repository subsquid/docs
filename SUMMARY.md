...
* [Guides](recipes/README.md)
  * [Fire Squid Release](recipes/fire-squid-release/README.md)
    * [Migrate to Fire Squid](recipes/fire-squid-release/migrate-to-fire-squid.md)
    * [Call Wrappers handling](recipes/fire-squid-release/call-wrappers-handling.md)
    * [Batch processing](recipes/fire-squid-release/batch-processing.md)
    * [Data Selection on Handler Context](recipes/fire-squid-release/data-selection-on-handler-context.md)
    * [Multiple databases (foundational) support](recipes/fire-squid-release/multiple-databases-foundational-support.md)
    * [Lazy transactions](recipes/fire-squid-release/lazy-transactions.md)
    * [Logger interface](recipes/fire-squid-release/logger-interface.md)
    * [WASM support](recipes/fire-squid-release/wasm-support.md)
